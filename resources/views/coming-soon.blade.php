...
<body>
    ...
    <section id="subscribe" class="section-style parallax-bg" data-background-image="/frontend/coming-soon/parallax/images/background/newsletter.jpg">
        ...
        <footer id="footer-section">
            <p class="copyright">
                &copy; <a href="/">{{ $global_params['site_name'] or 'liveCMS' }}</a> 2015-2016, All Rights Reserved. Designed by & Developed by <a href="http://hiret.web.id">Hiret Web Indonesia</a>
            </p>
        </footer>
        <!-- Footer Section End -->
